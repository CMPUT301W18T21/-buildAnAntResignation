...
public class UserProfileElasticSearchController {
    ...
    public static void syncOnlineWithOffline(UserProfile offlineUserProfile) {
        ...
        UserProfileElasticSearchController.UpdateUserProfileTask updateUserProfileTask = new UpdateUserProfileTask();
