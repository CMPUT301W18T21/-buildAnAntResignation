    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(RequesterTaskDetail.this);
                View mView =getLayoutInflater().inflate(R.layout.dialog_select_bid, null);
                Button accept = (Button) mView.findViewById(R.id.buttonAccept);
                Button decline = (Button) mView.findViewById(R.id.buttonDecline);
